...
export default function Step3Ops() {
  const { state, dispatch } = useLoadSheet()

  const inputCls = 'w-full px-2.5 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-[#1a3a5c] focus:ring-1 focus:ring-[#1a3a5c]'
