        ...
        <table className="w-full text-sm border-collapse border border-gray-300">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="p-0">
                <input className={inputClass} type="number" min="0" value={fd.taxiMin} onChange={e => setField('taxiMin', e.target.value)} placeholder="min" />
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="p-0">
                <input className={inputClass} type="number" min="0" value={fd.tripMin} onChange={e => setField('tripMin', e.target.value)} placeholder="min" />
              </td>
            </tr>
            <tr className="border-b border-gray-200">
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="p-0">
                <input className={inputClass} type="number" min="0" value={fd.alt1Min} onChange={e => setField('alt1Min', e.target.value)} placeholder="min" />
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="p-0">
                <input className={inputClass} type="number" min="0" value={fd.alt2Min} onChange={e => setField('alt2Min', e.target.value)} placeholder="min" />
              </td>
            </tr>
            <tr className="border-b border-gray-200">
